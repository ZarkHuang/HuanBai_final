    ...
    return(
            ...
            <div className="container">
                    ...
                    <div className="col-lg-5">
                        <div className="evnIntro_l-left">
                            <div classNameName="textBox">
                                <div classNameName="subTitle">Introduction</div>
                                <div classNameName="mainTitle">循環杯是什麼？</div>
                            </div>
                ...
                <div className="col-lg-7">
                    <div className="evnIntro_l-right">
                        <img className="decoPot1" src={decoPot1} />
                        <div className="evnIntro_imgBox">
                            <img className="img-evnIntro" src={imgEvnIntro} />
                            <img className="img-evnCupIll" src={imgEvnCupIll} />
                        </div>
                        <img className="decoPot2" src={decoPot2} />
                        <img className="decoPot3" src={decoPot3} />
                        <img className="decoPot4" src={decoPot4} />
                    </div>
                </div>
        ...
        <div className="needBox">
            <div className="needBox_bg">
                ...
                <div className="container">
                    <div classNameName="textBox">
                        <div classNameName="subTitle">Why is it needed</div>
                        <div classNameName="mainTitle">為什麼需要循環杯</div>
                    </div>
                    <div className="needBox_introWrap">
                        <img className="whitePot1" src={whitePot1} />
    
                        <div className="needBox_content">
                            <img src={needTextDeco} />
        ...
        <div className="startBox">
            <div className="container">
                <div classNameName="textBox">
                    <div classNameName="subTitle">How to start</div>
                    <div classNameName="mainTitle">如何開始</div>
                </div>
            </div>
        </div>
        <div className="benefitsBox">
            <div className="benefitsBox_bg">
                <img src={benefitsDeco} />
                <div className="container">
                    <div classNameName="textBox">
                        <div classNameName="subTitle">Benefits</div>
                        <div classNameName="mainTitle">經濟效益</div>
                    </div>
                    <div className="benefits_list">
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="benefits_item">
                                    <div className="benefits_item_bg"></div>
                            ...
                            <div className="col-lg-4">
                                <div className="benefits_item">
                                    ...
                                    <div className="benefits_item_content">
                                        ...
                                        <div className="benefits_item_text">減少垃圾的堆放和焚燒所產生的污染，改善空氣和水質，保護生態環境的健康和可持續性，提高綠色就業和經濟增長。
                                        </div>
                                    </div>
                                    <img className="ico-benefits" src={benefitsIcon} />
                                </div>
        ...
        <div className="policyBox">
            <div className="container">
                <div className="row">
                    <div className="col-lg-5">
                        <div classNameName="textBox">
                            <div classNameName="subTitle">Policy Support</div>
                            <div classNameName="mainTitle">政策支持</div>
                        </div>
                    ...
                    <div className="col-lg-7">
                        <div className="policy_list">
                            <div className="policy_item">
                                <img src="../img/evnIntro/shop-711.svg" />
                            </div>
                            <div className="policy_item">
                                <img src="../img/evnIntro/shop-MD.svg" />
                            </div>
                            <div className="policy_item">
                                <img src="../img/evnIntro/shop-MB.svg" />
                            </div>
                            <div className="policy_item">
                                <img src="../img/evnIntro/shop-KFC.svg" />
                            </div>
                        </div>
                    </div>
                </div>
